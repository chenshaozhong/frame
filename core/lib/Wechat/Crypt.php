...
class Crypt{
    ...
    {
        $this->token = is_null($token) ? config('TOKEN') : $token;
        $this->encodingAesKey = is_null($encodingAesKey) ? config('EncodingAesKey') : $encodingAesKey;
...
/**
使用
include_once "WxCrypt.class.php";
...
$pc = new WxCrypt($token, $encodingAesKey, $appId);
$encryptMsg = '';
